...
UPDATE stock SET estatus = 1;
-- [id_receta,cantidad,precio] 2 de 1 y 1 de 1
CALL insertar_venta('[[1,2,299.99],[2,1,199.99]]',1);
-- 1 SE PUEDE 7 - 5 199.99 Y 2 299.99
-- 2 SE PUEDE 4 DE 199.99
-- SELECT dv.cantidad, dv.precio, fk_stock, fk_venta, id_stock, caducidad, s.cantidad, s.precio, estatus, fk_receta FROM detalle_venta dv RIGHT JOIN stock s ON id_stock = fk_stock;
SELECT * FROM venta;
-- SELECT * FROM stock;
SELECT * FROM detalle_venta;
-- SELECT * FROM stock WHERE id_stock = 3 ORDER BY fk_receta ; -- 1 de 1, 2 de 1
